...
/*
	...
	[@RequestParam]
	-----------------------
	@RequestParam Annotation은 key=value 형태로 화면에서 넘어오는 파라미터를
	mapping된 method의 파라미터에 전달해준다.
	주로, get 방식으로 들어오는 request에서 사용된다.
	
	[@ModelAttribute]
	-----------------------
	@ModelAttribute Annotation은 화면의 form 속성으로 넘어온 model을
	mapping된 method의 파라미터에 전달해준다.
	...
	[@SessionAttribute]
	-----------------------
	@SessionAttribute Annotation은 session에서
	model의 정보를 유지하고 싶을 때 사용된다.
*/
